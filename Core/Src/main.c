...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define FDCAN_RX_FIFO_WATERMARK 32

#define FDCAN_IT_SOURCES	( 	FDCAN_IT_TX_EVT_FIFO_NEW_DATA	\
							  |	FDCAN_IT_RX_FIFO0_NEW_MESSAGE	\
							  | FDCAN_IT_RX_FIFO0_WATERMARK 	\
                              | FDCAN_IE_EPE | FDCAN_IE_BOE )
/* USER CODE END PD */
...
void SystemClock_Config(void)
{
  ...
  */
  ...
  RCC_OscInitStruct.PLL.PLLR = 120;
...
void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.RxFifo0ElmtsNbr = 35;
  ...
  HAL_FDCAN_ConfigFifoWatermark  ( &hfdcan1, FDCAN_CFG_RX_FIFO0, FDCAN_RX_FIFO_WATERMARK );
  HAL_FDCAN_ActivateNotification ( &hfdcan1, FDCAN_IT_SOURCES, 0 );
...
void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Init.RxFifo0ElmtsNbr = 35;
  ...
  HAL_FDCAN_ConfigFifoWatermark  ( &hfdcan2, FDCAN_CFG_RX_FIFO0, FDCAN_RX_FIFO_WATERMARK );
  HAL_FDCAN_ActivateNotification ( &hfdcan2, FDCAN_IT_SOURCES, 0 );
