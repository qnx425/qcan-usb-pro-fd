...
#define USBD_MANUFACTURER_STRING        "QCAN"
#if  PCAN_PRO_FD
#define USBD_PID_HS                     0x0011
#define USBD_PRODUCT_STRING_HS          "QCAN-USB Pro FD"
#define USBD_INTERFACE_CAN_STRING_HS    "QCAN-USB Pro FD CAN"
#define USBD_INTERFACE_LIN_STRING_HS    "QCAN-USB Pro FD LIN"
#elif PCAN_FD
#define USBD_PID_HS                     0x0012
#define USBD_PRODUCT_STRING_HS          "QCAN-USB FD"
#define USBD_INTERFACE_CAN_STRING_HS    "QCAN-USB FD CAN"
#define USBD_INTERFACE_LIN_STRING_HS    "QCAN-USB FD LIN"
#elif PCAN_PRO
#define USBD_PID_HS                     0x000d
#define USBD_PRODUCT_STRING_HS          "QCAN-USB-PRO"
#define USBD_INTERFACE_CAN_STRING_HS    "QCAN-USB-PRO CAN Device"
#define USBD_INTERFACE_LIN_STRING_HS    "QCAN-USB-PRO LIN Device"
#elif PCAN_X6
#define USBD_PID_HS                     0x0014
#define USBD_PRODUCT_STRING_HS          "QCAN-USB X6"
#define USBD_INTERFACE_CAN_STRING_HS    "QCAN-USB X6 CAN Device"
#define USBD_INTERFACE_LIN_STRING_HS    "QCAN-USB X6 LIN Device"
#else
#error Oops
#endif
